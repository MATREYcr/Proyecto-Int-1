...
class PacientesPage extends React.Component{
    state = {
      data: data,
      form:{
        id:0,
...
export default PacientesPage;
    ...
    // const AddPatients =()=>{
    //     console.log("Entrro a add");
    //     Patients.push({name: "Pedro", "age": 12, "doctor": "",date:""})
    //     console.log(Patients,"Patieents")
    // }
    ...
    //             <table>
    //                 <thead style={{ height: "90px", padding: "2%" }}>
    //                 <th>Name</th>
    //                 <th>Age</th>
    //                 <th>Doctor</th>
    //                 <th>Date</th>
    ...
    //             </table>
    //         </div>
    //         <button onClick={AddPatients}>
    //             Add Patients
    //         </button>
    //         <button onClick={UpdatePatients}>
    //             Update Patients
    //         </button>
    //         <button onClick={DeletePatients}>
    //             Delete Patients
    //         </button>
